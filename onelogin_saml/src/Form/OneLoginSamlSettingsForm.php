...
class OneLoginSamlSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['provider']['single_logout_url'] = array(
      ...
      '#default_value' => $config->get('single_logout_url'),
    ...
    $form['provider']['x_509_certificate'] = array(
      ...
      '#required' => TRUE,
      '#default_value' => $config->get('x_509_certificate'),
    ...
    //   '#default_value' => $config->get('sync_roles'),
    ...
    //   '#required' => TRUE,
    //   '#default_value' => $config->get('account_match'),
    //   '#options' => array(
    //     'username' => 'username',
    //     'email' => 'email',
    //   ),
    ...
    //   '#default_value' => $config->get('disable_password_field'),
    ...
    //   '#default_value' => $config->get('disable_password_tab'),
    ...
    //   '#default_value' => $config->get('custom_new_account_link'),
    ...
    //   '#default_value' => $config->get('custom_new_password_link'),
    ...
    //   '#default_value' => $config->get('name_id_format'),
